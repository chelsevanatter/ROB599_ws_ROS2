...
static const _ApplyBrakes_Request_type_support_symbol_names_t _ApplyBrakes_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_hw2_msgs, srv, ApplyBrakes_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_hw2_msgs, srv, ApplyBrakes_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rob599_hw2_msgs, srv, ApplyBrakes_Request)() {
  return &::rob599_hw2_msgs::srv::rosidl_typesupport_c::ApplyBrakes_Request_message_type_support_handle;
}
...
static const _ApplyBrakes_Response_type_support_symbol_names_t _ApplyBrakes_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_hw2_msgs, srv, ApplyBrakes_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_hw2_msgs, srv, ApplyBrakes_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rob599_hw2_msgs, srv, ApplyBrakes_Response)() {
  return &::rob599_hw2_msgs::srv::rosidl_typesupport_c::ApplyBrakes_Response_message_type_support_handle;
}
...
static const _ApplyBrakes_type_support_symbol_names_t _ApplyBrakes_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rob599_hw2_msgs, srv, ApplyBrakes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rob599_hw2_msgs, srv, ApplyBrakes)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rob599_hw2_msgs, srv, ApplyBrakes)() {
  return &::rob599_hw2_msgs::srv::rosidl_typesupport_c::ApplyBrakes_service_type_support_handle;
}
