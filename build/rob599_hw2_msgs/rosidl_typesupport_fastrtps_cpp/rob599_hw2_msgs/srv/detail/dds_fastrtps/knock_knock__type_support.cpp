...
#include "rob599_hw2_msgs/srv/detail/knock_knock__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rob599_hw2_msgs::srv::KnockKnock_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rob599_hw2_msgs::srv::KnockKnock_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rob599_hw2_msgs::srv::KnockKnock_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _KnockKnock_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rob599_hw2_msgs::srv::KnockKnock_Request *>(
...
static size_t _KnockKnock_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_KnockKnock_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _KnockKnock_Request__callbacks = {
  "rob599_hw2_msgs::srv",
  "KnockKnock_Request",
...
static rosidl_message_type_support_t _KnockKnock_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_KnockKnock_Request__callbacks,
...
{
  return &rob599_hw2_msgs::srv::typesupport_fastrtps_cpp::_KnockKnock_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = rob599_hw2_msgs::srv::KnockKnock_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rob599_hw2_msgs::srv::KnockKnock_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rob599_hw2_msgs::srv::KnockKnock_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _KnockKnock_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rob599_hw2_msgs::srv::KnockKnock_Response *>(
...
static size_t _KnockKnock_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_KnockKnock_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _KnockKnock_Response__callbacks = {
  "rob599_hw2_msgs::srv",
  "KnockKnock_Response",
...
static rosidl_message_type_support_t _KnockKnock_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_KnockKnock_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &rob599_hw2_msgs::srv::typesupport_fastrtps_cpp::_KnockKnock_Response__handle;
}
...
static service_type_support_callbacks_t _KnockKnock__callbacks = {
  "rob599_hw2_msgs::srv",
  "KnockKnock",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_hw2_msgs, srv, KnockKnock_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rob599_hw2_msgs, srv, KnockKnock_Response)(),
...
static rosidl_service_type_support_t _KnockKnock__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_KnockKnock__callbacks,
...
{
  return &rob599_hw2_msgs::srv::typesupport_fastrtps_cpp::_KnockKnock__handle;
}
